<?php use EDD\Blocks\Functions; ?>
    <fieldset id="edd_cc_address" class="edd-blocks-form cc-address">
        ...
        <div id="edd-card-address-wrap" class="edd-blocks-form__group edd-blocks-form__group-address">
            ...
            <input type="text" id="card_address" name="card_address" class="<?php echo esc_attr(
				implode( ' ', Functions\get_input_classes( 'card_address', [ 'edd-input' ] ) )
			); ?>" placeholder="<?php esc_html_e( 'Address line 1', 'easy-digital-downloads' ); ?>" value="<?php echo esc_attr( $customer[ 'address' ][ 'line1' ] ); ?>"<?php Functions\mark_field_required(
				'card_address'
			); ?>/>
        </div>
        <div id="edd-card-address-2-wrap" class="edd-blocks-form__group edd-blocks-form__group-address2">
            ...
            <input type="text" id="card_address_2" name="card_address_2" class="<?php echo esc_attr(
				implode( ' ', Functions\get_input_classes( 'card_address_2', [ 'edd-input' ] ) )
			); ?>" placeholder="<?php esc_html_e( 'Address line 2', 'easy-digital-downloads' ); ?>" value="<?php echo esc_attr( $customer[ 'address' ][ 'line2' ] ); ?>"<?php Functions\mark_field_required(
				'card_address_2'
			); ?>/>
        </div>
        <div id="edd-card-city-wrap" class="edd-blocks-form__group edd-blocks-form__group-city">
            ...
            <input type="text" id="card_city" name="card_city" class="<?php echo esc_attr( implode( ' ', Functions\get_input_classes( 'card_city', [ 'edd-input' ] ) ) ); ?>" placeholder="<?php esc_html_e(
				'City',
				'easy-digital-downloads'
			); ?>" value="<?php echo esc_attr( $customer[ 'address' ][ 'city' ] ); ?>"<?php Functions\mark_field_required( 'card_city' ); ?>/>
        </div>
        <div id="edd-card-zip-wrap" class="edd-blocks-form__group edd-blocks-form__group-zip">
            ...
            <input type="text" id="card_zip" name="card_zip" class="<?php echo esc_attr( implode( ' ', Functions\get_input_classes( 'card_zip', [ 'edd-input' ] ) ) ); ?>" placeholder="<?php esc_html_e(
				'Zip / Postal Code',
				'easy-digital-downloads'
			); ?>" value="<?php echo esc_attr( $customer[ 'address' ][ 'zip' ] ); ?>"<?php Functions\mark_field_required( 'card_zip' ); ?>/>
        </div>
        <div id="edd-card-country-wrap" class="edd-blocks-form__group edd-blocks-form__group-country">
            ...
            <select name="billing_country" id="billing_country" data-nonce="<?php echo esc_attr( wp_create_nonce( 'edd-country-field-nonce' ) ); ?>" class="<?php echo esc_attr(
				implode( ' ', Functions\get_input_classes( 'billing_country', [ 'edd-select' ] ) )
			); ?>"<?php Functions\mark_field_required( 'billing_country' ); ?>>
				<?php
        ...
        <div id="edd-card-state-wrap" class="edd-blocks-form__group edd-blocks-form__group-state">
			...
			if ( ! empty( $states ) ) :
				?>
                <select name="card_state" id="card_state" class="<?php echo esc_attr( implode( ' ', Functions\get_input_classes( 'card_state', [ 'edd-select' ] ) ) ); ?>"<?php Functions\mark_field_required(
					'card_state'
				); ?>>
					<?php
			...
			<?php
				...
				?>
                <input type="text" name="card_state" id="card_state" class="<?php echo esc_attr(
					implode( ' ', Functions\get_input_classes( 'card_state', [ 'edd-input' ] ) )
				); ?>" value="<?php echo esc_attr( $customer_state ); ?>" placeholder="<?php esc_html_e( 'State/Province', 'easy-digital-downloads' ); ?>"<?php Functions\mark_field_required(
					'card_state'
				); ?>/>
			<?php endif; ?>
        </div>
